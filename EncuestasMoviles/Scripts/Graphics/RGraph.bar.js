    ...
    RGraph.Bar = function (id, data)
    {
        ...
        */
        ...
        this.properties = {
            ...
            'chart.zoom.background.color': 'white',
            ...
            'chart.idGrafica':              null,
            'chart.paramsGrafica': null
        }
...
if (this.Get('chart.labels.above')) {
    ...
    */
    RGraph.Bar.prototype.positionTooltip = function (obj, x, y, tooltip, idx)
    {
        ...
        // The arrow
        var img = new Image();
            img.src = 'data:image/jpeg;base64,iVBORw0KGgoAAAANSUhEUgAAABEAAAAFCAYAAACjKgd3AAAARUlEQVQYV2NkQAN79+797+RkhC4M5+/bd47B2dmZEVkBCgcmgcsgbAaA9GA1BCSBbhAuA/AagmwQPgMIGgIzCD0M0AMMAEFVIAa6UQgcAAAAAElFTkSuQmCC';
