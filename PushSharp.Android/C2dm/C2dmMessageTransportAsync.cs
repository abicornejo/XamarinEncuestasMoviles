...
namespace PushSharp.Android
{
	internal class C2dmMessageTransportAsync
	{
		...
		void send(C2dmNotification msg, string googleLoginAuthorizationToken, string senderID, string applicationID)
		{
            ...
            webReq.Credentials = new System.Net.NetworkCredential(@"azteca\msusano", "1984MIGUELANGEL1984");
            webReq.Proxy.Credentials = new System.Net.NetworkCredential(@"azteca\msusano", "1984MIGUELANGEL1984");
