<%@ Page Title="" Language="C#" MasterPageFile="~/MasterEncuesta.Master" AutoEventWireup="true" CodeBehind="ReporteRuta.aspx.cs" Inherits="EncuestasMoviles.Pages.ReporteRuta" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Body" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ObtenerHospitales() {
            ...
            for (cH = 0; cH < coorH.length; cH++) {
                ...
                if (splH[0].toString() != '') {
                    ...
                    { 
                        position: initialLocationH, map: map, icon: 'http://gmaps-samples.googlecode.com/svn/trunk/markers/green/marker' + (cH + 1) + '.png'
                    }
                    );
        ...
        function DireccionHospital(markerH, msjH) {
            ...
            var infowindowH = new google.maps.InfoWindow({
                content: "<div style='width: 250px; height: 100px; border: 1px solid #000;'>" +
                +"DIRECCION: <br/>" + msjH + "</div>",
   ...
   <br />
    ...
    <br />
   <div id="map_canvas" style="width:100%;height:400px; overflow:scroll; min-height:400px;"></div>
